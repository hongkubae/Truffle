...
import  {  vegetable, bread, fruit, sausage, seafood, truffle, noodle, spice, bean, grain, meat, milk }  from '../components/IngredientsArray';
...
<View style={{marginTop: 22}}>
    ...
    <View style={{width: '100%', alignItems: 'center',  backgroundColor: '#F8F9FA', postition: 'absolute' }}>
  <TouchableOpacity
        style={styles.button}
        onPress={() => navigation.navigate('AddRecipeMain')}>
        <Text style={styles.buttonText}>총 {count}개의 재료 추가하기</Text>
      </TouchableOpacity>
  </View>
